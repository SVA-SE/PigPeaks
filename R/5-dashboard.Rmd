...
for (i in indicators.to.keep.excel$indicators.labels[indicators.to.keep.excel$category=="gilts"]) {
  ...
  if (isTRUE(indicators.to.keep.excel[, "sys"][indicators.to.keep.excel$indicators.labels==i])) {
    ...
    if (indicators.to.keep.excel[, "limits"][indicators.to.keep.excel$indicators.labels==i]=="limit.lw") {
...
# for (ind in names(indicators.data)[indicators.categories=="empty sows"]) {
#   #ind=indicators.to.keep.excel$indicators[indicators.to.keep.excel$category=="empty sows"][1]
#   
for (i in indicators.labels[indicators.categories=="empty sows"]) {
  #i=indicators.labels[which(indicators.categories=="empty sows")][1]
...
# for (ind in names(indicators.data)[indicators.categories=="services"]) {
#   #ind=names(indicators.data)[indicators.categories=="services"][1]
#   
  for (i in indicators.labels[indicators.categories=="services"]) {
    #i=indicators.labels[indicators.categories=="services"][1]
...
#   #ind=indicators.to.keep.excel$indicators[indicators.to.keep.excel$category=="pregnancy"][1]
  ...
  for (i in indicators.to.keep.excel$indicators.labels[indicators.to.keep.excel$category=="pregnancy"]) {
    #i=indicators.to.keep.excel$indicators.labels[indicators.to.keep.excel$category=="pregnancy"][1]
...
#   
  for (i in indicators.to.keep.excel$indicators.labels[indicators.to.keep.excel$category=="farrowing"]) {
    #i=indicators.to.keep.excel$indicators.labels[indicators.to.keep.excel$category=="farrowing"][2]
...
#   
  for (i in indicators.to.keep.excel$indicators.labels[indicators.to.keep.excel$category=="weaning"]) {
  #i=indicators.to.keep.excel$indicators.labels[indicators.to.keep.excel$category=="weaning"][3]
...
#   
for (i in indicators.to.keep.excel$indicators.labels[indicators.to.keep.excel$category=="post-weaning"]) {
  #i=indicators.to.keep.excel$indicators.labels[indicators.to.keep.excel$category=="post-weaning"][1]
...
#   #i=indicators.to.keep.excel$indicators.labels[indicators.to.keep.excel$category=="exit"][1]
#   
  for (i in indicators.to.keep.excel$indicators.labels[indicators.to.keep.excel$category=="exit"]) {
  #i=indicators.to.keep.excel$indicators.labels[indicators.to.keep.excel$category=="exit"][1]
