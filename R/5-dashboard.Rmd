...
```{r, fig.width=14, fig.height=12}
  gauge(42, min = 0, max = 100, symbol = '%', label = "Gilts", gaugeSectors(
    success = c(80, 100), warning = c(40, 79), danger = c(0, 39), colors = c("#33cc33","#ffcc00","#cc0000")
  ))

```

```{r, fig.width=14, fig.height=12}
  gauge(31, min = 0, max = 100, symbol = '%', label = "Empty Sows", gaugeSectors(
    success = c(80, 100), warning = c(40, 79), danger = c(0, 39), colors = c("#33cc33","#ffcc00","#cc0000")
  ))
...
```{r, fig.width=14, fig.height=12}
  gauge(97, min = 0, max = 100, symbol = '%', label = "Services", gaugeSectors(
    success = c(80, 100), warning = c(40, 79), danger = c(0, 39), colors = c("#33cc33","#ffcc00","#cc0000")
  ))
...
```{r, fig.width=14, fig.height=12}
  gauge(50, min = 0, max = 100, symbol = '%', label = "Pregnancy", gaugeSectors(
    success = c(80, 100), warning = c(40, 79), danger = c(0, 39), colors = c("#33cc33","#ffcc00","#cc0000")
  ))
...
```{r, fig.width=16, fig.height=10}
  gauge(80, min = 0, max = 100, symbol = '%', label = "Farrowing", gaugeSectors(
    success = c(80, 100), warning = c(40, 79), danger = c(0, 39), colors = c("#33cc33","#ffcc00","#cc0000")
  ))
...
```{r, fig.width=16, fig.height=10}
  gauge(27, min = 0, max = 100, symbol = '%', label = "Weaning", gaugeSectors(
    success = c(80, 100), warning = c(40, 79), danger = c(0, 39), colors = c("#33cc33","#ffcc00","#cc0000")
  ))
...
```{r, fig.width=16, fig.height=10}
  gauge(78, min = 0, max = 100, symbol = '%', label = "Post-Weaning", gaugeSectors(
    success = c(80, 100), warning = c(40, 79), danger = c(0, 39), colors = c("#33cc33","#ffcc00","#cc0000")
  ))
...
```{r, fig.width=16, fig.height=10}
  gauge(50, min = 0, max = 100, symbol = '%', label = "Exit", gaugeSectors(
    success = c(80, 100), warning = c(40, 79), danger = c(0, 39), colors = c("#33cc33","#ffcc00","#cc0000")
  ))
...
if("time.to.reservice" %in% names(indicators.data)) {
  ...
  i = which(names(indicators.data)=="time.to.reservice")
    ...
    cat("  \n###", indicators.labels[i],", number of events and alarms per year","  \n")
  
    TS.barplot.continuous.events(df.indicator=indicators.continuous.to.weekly[[i]],
                                 years.to.see = 3,
...
if("time.to.reservice" %in% names(indicators.data)) {
  ...
  cat("In the graph on the side, parity is represented as a moving average of",moving_average, "weeks, used to identify trend direction.")
}
