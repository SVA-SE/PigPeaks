...
for (i in which(indicators.categories=="gilts")) {
  ...
  #i=indicators.categories=="gilts"[1]
...
#   #ind=indicators.to.keep.excel$indicators[indicators.to.keep.excel$category=="pregnancy"][1]
  ...
  for (i in which(indicators.categories=="pregnancy")) {
    #i=indicators.categories=="pregnancy"][1]
...
#   
  for (i in which(indicators.categories=="farrowing")) {
    #i=indicators.categories=="farrowing"][2]
...
#   
  ...
  #i=indicators.categories=="weaning"][3]
...
for (i in which(indicators.categories=="post-weaning")) {
  #i=indicators.categories=="post-weaning"][1]
...
#   #i=indicators.categories=="exit"][1]
#   
