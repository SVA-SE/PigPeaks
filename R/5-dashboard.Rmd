...
#   
for (i in which(indicators.labels=="empty sows")) {
...
#   #ind=indicators.to.keep.excel$indicators[indicators.to.keep.excel$category=="pregnancy"][1]
  ...
  for (i in which(indicators.category=="pregnancy")) {
...
#   
  for (i in which(indicators.category=="farrowing")) {
...
#   
  for (i in which(indicators.category=="weaning")) {
...
#   
for (i in which(indicators.category=="post-weaning")) {
...
#   
  for (i in which(indicators.category=="exit")) {
  #i=indicators.category=="exit"][1]
